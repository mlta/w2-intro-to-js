...
// 4.
// What is `greeting` set to? ( qUE TE RESPONDERIA LA COMPUTADORA )
let greeting = "Hello, how are you? " + givenName;
// A: Hello, how are you? Tim


// 5.
// What is `math` set to? hacer la suma
let high = 50;
let low  = 10;
let math = high - low;
// A:40
...
let timAge = 'Tim is ' + age + 'years old'
console.log(timAge);
// 8.
...
yourName = 'Maria Laura'
instructorName = 'Gavin'
